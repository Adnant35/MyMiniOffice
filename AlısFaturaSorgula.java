 ...
 * @author adnan
 */
public class AlısFaturaSorgula extends javax.swing.JFrame {

    /**
     * Creates new form AlısFaturaSorgula
     */
    public AlısFaturaSorgula() {
        initComponents();
    }
...
private  void Seticon(){
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
      Seticon();
        ...
        try (ResultSet rs = st.executeQuery("Select * from AlısFatura")) {//Veritabanındaki tabloya bağlandık
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlısFaturaSorgula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlısFaturaSorgula().setVisible(true);
            }
        });
    }
