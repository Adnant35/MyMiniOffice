 ...
 * @author adnan
 */
public class StokDurum extends javax.swing.JFrame {

    /**
     * Creates new form StokDurum
     */
    public StokDurum() {
        initComponents();
    }
...
private  void Seticon(){
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try (ResultSet rs = st.executeQuery("Select * from Depo")) {//Veritabanındaki tabloya bağlandık
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StokDurum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
