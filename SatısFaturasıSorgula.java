 ...
 * @author adnan
 */
public class SatısFaturasıSorgula extends javax.swing.JFrame {

    /**
     * Creates new form SatısFaturasıSorgula
     */
    public SatısFaturasıSorgula() {
        initComponents();
    }
...
private  void Seticon(){
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try (ResultSet rs = st.executeQuery("Select * from SatısFatura")) {//Veritabanındaki tabloya bağlandık
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
         SatısFaturası um = new SatısFaturası();
        um.setVisible(true);
        um.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SatısFaturasıSorgula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SatısFaturasıSorgula().setVisible(true);
            }
        });
    }
