 ...
 * @author adnan
 */
public class KrediKartlarım extends javax.swing.JFrame {

    /**
     * Creates new form KrediKartlarım
     */
    public KrediKartlarım() {
        initComponents();
    }
...
private  void Seticon(){
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try (ResultSet rs = st.executeQuery("Select * from KrediKartları")) {//Veritabanındaki tabloya bağlandık
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KrediKartlarım.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KrediKartlarım().setVisible(true);
            }
        });
    }
