 ...
 * @author adnan
 */
public class Satısİrsaliyelerim extends javax.swing.JFrame {

    /**
     * Creates new form Satısİrsaliyelerim
     */
    public Satısİrsaliyelerim() {
        initComponents();
    }
...
private  void Seticon(){
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
       Seticon();
        ...
        try (ResultSet rs = st.executeQuery("Select * from İrsaliye")) {//Veritabanındaki tabloya bağlandık
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        Satısİrsaliye um = new Satısİrsaliye();
        um.setVisible(true);
        um.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Satısİrsaliyelerim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Satısİrsaliyelerim().setVisible(true);
            }
        });
    }
