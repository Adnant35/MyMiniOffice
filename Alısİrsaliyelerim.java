 ...
 * @author adnan
 */
public class Alısİrsaliyelerim extends javax.swing.JFrame {

    /**
     * Creates new form Alısİrsaliyelerim
     */
    public Alısİrsaliyelerim() {
        initComponents();
    }
...
private  void Seticon(){
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
       Seticon();
        ...
        try (ResultSet rs = st.executeQuery("Select * from İrsaliyeGelis")) {//Veritabanındaki tabloya bağlandık
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
         Alısİrsaliye um = new Alısİrsaliye();
        um.setVisible(true);
        um.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Alısİrsaliyelerim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Alısİrsaliyelerim().setVisible(true);
            }
        });
    }
